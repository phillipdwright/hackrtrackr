...
BASE_DB_FILE_PATH = '/home/ubuntu/workspace/hackrtrackr-test/test_db/'
db_name = "testDB12.db"
full_db_path = BASE_DB_FILE_PATH + db_name
#historic_data = "/home/ubuntu/workspace/hackrtrackr-test/data/comments.json"
...
def create_db(starting_data, *tables):
    ...
    y = conn.execute('''SELECT industry from company limit 10''')
